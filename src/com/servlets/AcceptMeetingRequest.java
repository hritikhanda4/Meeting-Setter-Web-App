...
public class AcceptMeetingRequest extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int result=Database.acceptMeetingFriendRequest(email,requestEmail,date,slot);
		if(result==1)
		{
			out.println("Success");
